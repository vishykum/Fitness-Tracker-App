...
const MusclemassModal: React.FC<MusclemassModalProps> = ({ show, onClose, onSubmit, data}) => {
    ...
    return (
        <div className={`modal ${show ? "block" : "hidden"}`} tabIndex={-1} role="dialog">
...
export default MusclemassModal;
